...
class TradeOfferChain {//php -d memory_limit=200M app/console doctrine:schema:update --dump-sql
     ...
     * Set userClosing
     *
     * @param \TradeOwl\TradeBundle\Entity\User $userClosing
     * @return TradeOfferChain
     */
    public function setUserClosing(\TradeOwl\TradeBundle\Entity\User $userClosing = null)
    {
