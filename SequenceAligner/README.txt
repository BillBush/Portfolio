...
4) The algorithms applied are asymptotically inefficient in both space and time.  This is in part to allow room for optimizing homework assignments.  It is also intended to unify certain concepts.  For instance the algorithm for computing longest common substring was chosen primarily for its reuse of code and concepts from the other alignment algorithms.
